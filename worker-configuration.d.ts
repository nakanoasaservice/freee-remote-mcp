/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4164d2ef8779527d52a07d336118b18f)
// Runtime types generated with workerd@1.20260310.1 2026-02-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FreeeTokenStoreDO" | "PendingStateDO";
	}
	interface Env {
		...
		WORKER_URL: string;
		FREEE_TOKEN_DO: DurableObjectNamespace<import("./src/index").FreeeTokenStoreDO>;
		PENDING_STATE_DO: DurableObjectNamespace<import("./src/index").PendingStateDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FREEE_CLIENT_ID" | "FREEE_CLIENT_SECRET" | "WORKER_URL">> {}
}
